...
class _CaregiverDashboardTabState extends State<CaregiverDashboardTab>
  ...
  void _listenToAlerts() {
    ...
    _alertStream = FirebaseFirestore.instance
      ...
      // Chercher la dernière alerte chute active (pendinge et récente)
                    ...
                    children: [
                      const Row(
                        children: [
                          ...
                          SizedBox(width: 10),
                          Text('Dernière position', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF2E5AAC))),
                        ],
                      ),
                    ...
                    children: [
                        ...
                        children: [
                          const Row(
                            children: [
                              ...
                              SizedBox(width: 10),
                              Text('Alertes récentes', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF2E5AAC))),
                            ],
                          ),
                      ...
                      if (_recentAlerts.isEmpty)
                        ...
                        ..._recentAlerts.take(5).map((a) {
                          ...
                          final isReminderMissed = type.contains('reminder_missed') || type.contains('rappel');
                          final color = isSOS 
  ...
  // ─────────────────────────────────────────────────────────────
  // Banner d'urgence chute (pulsant, avec position GPS)
  // ─────────────────────────────────────────────────────────────
            ...
            children: [
              ...
              Row(
                children: [
                  _infoChip(
                    Icons.timer,
                    ts != null ? _timeAgo(ts) : 'À l\'instant',
                  ),
                  const SizedBox(width: 10),
                  _infoChip(
                    Icons.psychology,
                    confirmed == 'patient' ? 'Confirmée' : 'Auto',
                  ),
                  if (confidence != null) ...[
                    const SizedBox(width: 10),
                    _infoChip(
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text('Position GPS non disponible', style: TextStyle(fontSize: 13, color: Colors.white70)),
                    ],
                  ),
                ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          const Text('Aucun patient lié', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF2E5AAC))),
          const SizedBox(height: 12),
          const Padding(
