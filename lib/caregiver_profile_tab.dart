...
class _CaregiverProfileTabState extends State<CaregiverProfileTab> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      if (patientUid == null) {
        final p = await FirebaseFirestore.instance.collection('users')
            .where('role', isEqualTo: 'patient').limit(1).get();
            ...
            child: Container(
              ...
              child: SingleChildScrollView(child: Column(
                  ...
                  children: [
                    ...
                    const Center(child: Text('Modifier les informations',
                    ...
                    DropdownButtonFormField<String>(
                        ...
                        onChanged: (v) { if (v != null) setSheetState(() => _diseaseStage = v); },
                    ...
                    _field(_doctorCtrl, 'Médecin référent',
                        Icons.medical_services_outlined),
                    const SizedBox(height: 14),
                    _field(_treatmentCtrl, 'Traitement',
                    ...
                    SizedBox(width: double.infinity, height: 54,
                        child: ElevatedButton(
                          onPressed: () { Navigator.pop(context); _savePatientInfo(); },
      ...
      body: Container(
        ...
        child: _isLoading
          ...
          child: Column(children: [
            ...
            Text(_patientData?['name'] ?? 'Patient',
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Configurer la zone de sécurité',
                                  style: TextStyle(fontSize: 16,
                                      fontWeight: FontWeight.w600,
                                      color: Color(0xFF2E5AAC))),
                              SizedBox(height: 4),
                              Text('Domicile, rayon de zone, notifications',
                ...
                child: OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(
                        ...
                        side: const BorderSide(
                            color: Color(0xFFFF5F6D), width: 2),
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(30))),
  ...
  Widget _card(String title, {required Widget child, Widget? action}) =>
      Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text(title, style: const TextStyle(fontSize: 17,
                  fontWeight: FontWeight.bold, color: Color(0xFF2E5AAC))),
