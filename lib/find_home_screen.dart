  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      ...
      final position = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high, // encore accepté mais déprécié
      );
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: const Color(0xFF2EC7F0).withValues(alpha: 0.3),
                            blurRadius: 20,
                          ),
                        ],
                      ),
                    ...
                    if (_homeAddress == null)
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: const Color(0xFFFFB74D).withValues(alpha: 0.3), width: 1.5),
                        ),
                        child: const Row(
                          children: [
